 ...
 ******************************************************************************/
/*******************************************************************************
 * Definitions for BAORD_BootClockVLPR configuration
 ******************************************************************************/
#define BAORD_BOOTCLOCKVLPR_CORE_CLOCK              4000000U  /*!< Core clock frequency: 4000000Hz */

/*! @brief MCG set for BAORD_BootClockVLPR configuration.
 */
extern const mcg_config_t mcgConfig_BAORD_BootClockVLPR;
/*! @brief SIM module set for BAORD_BootClockVLPR configuration.
 */
extern const sim_clock_config_t simConfig_BAORD_BootClockVLPR;
/*! @brief OSC set for BAORD_BootClockVLPR configuration.
 */
extern const osc_config_t oscConfig_BAORD_BootClockVLPR;

/*******************************************************************************
 * API for BAORD_BootClockVLPR configuration
 ******************************************************************************/
#if defined(__cplusplus)
extern "C" {
#endif /* __cplusplus*/
