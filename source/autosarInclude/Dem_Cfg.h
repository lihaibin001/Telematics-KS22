...
#define DEM_MAX_NUMBER_AGING_PRI_MEM			4

#define DEM_MAX_NR_OF_CLASSES_IN_FREEZEFRAME_DATA 3
#define DEM_MAX_NR_OF_RECORDS_IN_FREEZEFRAME_DATA 3

#define DEM_DID_IDENTIFIER_SIZE_OF_BYTES 3
