...
#define DCM_USE_SERVICE_REQUESTCURRENTPOWERTRAINDIAGDATA
#define DCM_USE_SERVICE_REQUESTPOWERTRAINFREEZEFRAMEDATA
#define DCM_USE_SERVICE_CLEAREMISSIONRELATEDDIAGNOSTICDATA
#define DCM_USE_SERVICE_REQUESTEMISSIONRELATEDDTCS
#define DCM_USE_SERVICE_REQUESTEMISSIONRELATEDDTCSDETECTEDDURINGCURRENTORLASCOMPLETEDDRIVINGCYCLE
#define DCM_USE_SERVICE_REQUESTVEHICLEINFORMATION
